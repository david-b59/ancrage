    ...
    <>
      <header>
        <div className="mb-0.5 flex items-baseline gap-2.5">
          ...
          <h1 className="m-0 text-[29px] font-semibold tracking-tight">Ancrage</h1>
        </div>
        <p className="mt-0.5 mb-[18px] font-mono text-[11px] tracking-[0.14em] text-dim uppercase">
          Révision espacée
        </p>
      </header>
      ...
      <div className="my-6 flex items-center gap-2.5">
        <span className="font-mono text-[11px] tracking-[0.18em] text-dim uppercase">Anglais · Lot 1</span>
